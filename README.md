...
The plugin supports the generation of static and dynamic user roles and root credential rotation in a standalone REDIS server or a REDIS cluster. REDIS Sentinel has not bee tested.
